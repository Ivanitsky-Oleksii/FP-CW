...
const Footer = (props: Props) => {
    return (
            ...
            <div className='footer'>© Copyright 2023 <a style={{paddingLeft:"100px"}} href="https://twitter.com/asot"><img src={twit} alt="#" style={{width:"40px",height:"40px",padding:"3px"}}/></a>
                            <a href="https://www.youtube.com/asotrecordings"><img src={youtube} alt="#" style={{width:"40px",height:"40px",padding:"3px"}}/></a>
                            <a href="https://www.instagram.com/asotlive/"><img src={inst} alt="#" style={{width:"40px",height:"40px",padding:"5px"}}/></a></div>
