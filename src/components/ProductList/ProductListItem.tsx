...
return (
    <Card  onClick={() => NewsPage1(title)}>
        <CardContent className="card-content">
            ...
            <Button color="error" size="small" variant="text" onClick={() => addProductToFavorite(id)}><Checkbox  icon={<FavoriteBorder sx={{color:"red"}} />} checkedIcon={<Favorite sx={{color:"red"}}/>} />like</Button>    
        </CardContent>
    </Card>
)
}
